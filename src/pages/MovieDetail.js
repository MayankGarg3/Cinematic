...
export const MovieDetail = () => {
  ...
  useEffect(() =>{
    async function fetchMovieDetail() {
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=4c5dfea900887b01fa05526f45e8f2b1`);
    ...
    <main>
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white ">
          ...
          <p className=" my-7 flex flex-wrap gap-2 my-4">
          ...
          <div className="flex items-center">
              ...
              <span className="text-sm font-medium text-gray-900 underline hover:no-underline dark:text-white">{movie.vote_count}</span>
          </div>
          ...
          <div className="flex flex-wrap gap-2 my-2">
          <p className="font-bold dark:text-white">Revenue:</p>
          <p>{movie.revenue}$</p>
          </div>
          
          <div className="flex flex-wrap gap-2 my-2">
          <p className="font-bold dark:text-white">Release Date:</p>
          <p>{movie.release_date}</p>
          </div>

          <div className="flex flex-wrap gap-2 my-2">
          <p className="font-bold dark:text-white">IMDB Code:</p>
